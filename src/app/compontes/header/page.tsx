...
<label onClick={()=>settoggle(!toggle)}   htmlFor="checkbox" className="toggle">
  <div style={{background:toggle?"white":undefined}} className="bar bar--top"></div>
  <div style={{background:toggle?"white":undefined}} className="bar bar--middle"></div>
  <div style={{background:toggle?"white":undefined}} className="bar bar--bottom"></div>
</label>

</div>
    <div className="box font-black nav">
        <nav>
            <ul style={{height:toggle?"40%":undefined }} className='flex '>
