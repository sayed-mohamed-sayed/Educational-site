...
export default function Footerr() {
    ...
    return (
        <div className=' w-screen h-[100px]  bg-black flex flex-wrap justify-start'>
            ...
            <div className="font-black text-white text-start mr-[25px]">
                <p>الرئسية</p>
                <p>تواصل معنا </p>
                <p>من نحن </p>
                <p>الشروط والاحكام</p>
            ...
            <div className=" p-2 text-center flex justify-center flex-col">
                ...
                <div className=" p-2 text-start flex justify-center mr-[40px]">
